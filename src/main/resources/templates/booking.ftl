                    ...
                    <div class="col">
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between">
                                <div>
                                    <h5 class="card-title">${item.apartment.name}</h5>
                                    <p><strong>Кількість ночей:</strong> ${nights[item_index]}</p>
                                    <p><strong>Ціна за ніч:</strong> ${item.apartment.pricePerNight} грн</p>
                                </div>
