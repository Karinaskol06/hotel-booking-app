...
<@p.pages>
    <div class="container mt-4">
        <h2 class="mb-4 text-center">Apartment Administration</h2>
        ...
        <div class="card mb-5 shadow-sm">
            ...
            <div class="card-body">
                <form method="post" action="/saveNewApartment">
                    ...
                    <div class="mb-3">
                        <label for="apartClass" class="form-label">Apartment Class</label>

                        <select name="apartClass" id="apartClass" class="form-select" required>
                            <option value="" disabled selected>Select apartment class</option>
                    ...
                    <div class="mb-3">
                        <label for="apartNumber" class="form-label">Number</label>
                    ...
                    <div class="text-center mt-3">
                        <button type="submit" class="btn btn-lg text-white"
                                style="background-color: #027353;">Add</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="card mb-5 shadow-sm">
            <div class="card-header text-white" style="background-color: #027353;">
                <h5 class="mb-0">Apartment Editing</h5>
            </div>
            <div class="card-body">
                                    ...
                                    <form method="post" action="/updateApartment" class="d-flex justify-content-center">
                                        ...
                                        <td>
                                            <input type="text" name="name" class="form-control form-control-sm rounded"
                                                   value="${a.name}" placeholder="Name" required>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="number" name="apartNumber" class="form-control form-control-sm rounded"
                                                   value="${a.apartmentNumber}" placeholder="No." required>
                                        </td>
                                        <td>
                                            <input type="number" name="capacity" class="form-control form-control-sm rounded"
                                                   value="${a.capacity}" placeholder="Guests" required>
                                        </td>
                                        <td>
                                            <input type="number" name="pricePerNight" class="form-control form-control-sm rounded"
                                                   value="${a.pricePerNight?string("0.##")}" step="0.01" placeholder="UAH/night" required>
                                        </td>
                                        <td>
                                            <input type="text" name="image" class="form-control form-control-sm rounded"
                                                   value="${a.linkImg}" placeholder="Image URL">
                                        </td>
                                        <td>
                                            <input type="number" name="area" class="form-control form-control-sm rounded"
                                                   placeholder="m²" value="${a.area?replace(',', '.')}" step="0.1" required>
                                        </td>
                                        <td>
                                            <input type="number" name="numOfRooms" class="form-control form-control-sm rounded"
                                                   value="${a.numOfRooms}" placeholder="Rooms" required>
                                        </td>
                                        <td>
                                            <button type="submit" class="btn btn-sm rounded b-upd" title="Update">
                                                <i class="bi bi-pencil-square fs-5"></i>
                                            </button>
                                        </td>
                                    </form>
                                    <form method="post" action="/deleteApartment"
                                          onsubmit="return confirm('Delete apartment?');">
                                        <td>
                                            <input type="hidden" name="idDel" value="${a.id}">
                                            <button type="submit" class="btn btn-sm rounded b-del" title="Delete">
